            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-6 md:p-8 shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-accent text-white px-4 py-3 md:px-6 md:py-4 rounded-xl font-semibold hover:bg-primary transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-base md:text-lg"
                >
                  {isSubmitting ? (
