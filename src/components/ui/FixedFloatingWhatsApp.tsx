...
export function FixedFloatingWhatsApp(): JSX.Element {
  ...
  return (
    <div className="fixed bottom-6 left-6 z-40">
      {/* Assistant Chat Box */}
      {showAssistant && (
        <div className="absolute bottom-16 left-0 w-64 bg-white rounded-xl shadow-xl p-4 mb-4 border border-gray-200 transform transition-all duration-300 dark:bg-gray-800 dark:border-gray-700">
          <div className="flex justify-between items-start mb-3">
            <h3 className="font-display font-bold text-primary text-lg dark:text-white">HR Assistant</h3>
            <button 
